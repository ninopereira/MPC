...
vector<double> MPC::Solve(Eigen::VectorXd x0, Eigen::VectorXd coeffs,
  ...
  // populate vectors for visualisation
  for (size_t j = 0; j < N; j++) {
    mpc_x_vals.push_back(solution.x[x_start + j]);
    mpc_y_vals.push_back(solution.x[y_start + j]);
  }
